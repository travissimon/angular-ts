...
gulp.task('inject-templates', ['wiredep', 'templatecache'], function() {
	...
	log('Template cache: ' + templateCache);
	return gulp
		   .src(config.index)
...
gulp.task('build-specs', ['templatecache'], function(done) {
	...
	return gulp
		   ...
		   .pipe(inject(gulp.src(config.testlibraries), {name: 'testlibraries'}))
		   .pipe(inject(gulp.src(config.specHelpers), {name: 'spechelpers'}))
		   .pipe(inject(gulp.src(specs), {name: 'specs'}, ['**/*']))
		   .pipe(inject(gulp.src(templateCache), {name: 'templates', }, 'templates'))
		   .pipe(gulp.dest(config.client));
});
 ...
 * @return {Stream}
 */
gulp.task('test', ['ts-lint', 'templatecache'], function(done) {
